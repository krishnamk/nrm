...
<html lang="en">
<head>
  <title><?php echo $sales_order_details['sales_order_number']; ?></title>
  <meta charset="UTF-8">
  ...
  <div class="row no-margin">
    <table style="width: 100%; border: none;">
     <tbody><tr style="border: none;">
       <th width="100%" style=" border: none;"> <h3>SALES RETURN</h3></th>
     </tr>
   </tbody></table>
   <table class="invoice_main">
    <tbody>
      <tr style="border-bottom: none;" class="invoice_top_res">
        <td style="border-right: none;width:25%;">  <span><b>SALES RETURN NO:</b></span></td>
        <td style="width:25%;"> <span><?php echo $sales_return_details['sales_return_number'];?></span></td>
        <td style="border-right: none;width:25%;">  <span><b>DATE:</b></span></td>
        <td style="width:25%;"> <span> <?php echo date('d-m-Y',strtotime($sales_return_details['sales_return_date']));?></span></td>
      </tr>
      <tr>
        <td colspan="2">
    ...
    <table style="border:1px solid #000; " class="table " border="2" width="100%">
      ...
      <tbody>
        ...
        <?php } ?>
        <tr>
          <td colspan="3" class="text-center" style="border-color:black;text-align:right;"><b>TOTAL QTY</b></td>
