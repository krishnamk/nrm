        ...
        <tr style="background: rgba(21,76,133,1); ">
          ...
          <?php } ?> -->
           <?php if(($this->common->get_particular('mst_product_settings',array('product_settings_name' => 'product_category'),'product_settings_value')== 1)){ ?>
            <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">CATEGORY</h5></th>
          <?php } ?>
      ...
      <tbody>
        ...
        foreach ($relations as $key => $relation) {
          ...
          <tr>
            ...
            <?php } ?> -->
            <?php if(($this->common->get_particular('mst_product_settings',array('product_settings_name' => 'product_category'),'product_settings_value')== 1)){ ?>
              <td class="text-center" style="border-color:black;text-align:center;"><?php echo $relation['category_name'];?></td>
            <?php } ?>
        ...
        <?php } ?>
        <tr>
          <td colspan="<?php if(($this->common->get_particular('mst_product_settings',array('product_settings_name' => 'product_brand'),'product_settings_value')== 1)){ ?>3<?php } else{ ?>2<?php } ?>" class="text-center" style="border-color:black;text-align:right;"><b>TOTAL</b></td>
          <td class="text-center" style="border-color:black;text-align:center;"><b><?php echo $total_quantity; ?></b></td>
          <td></td>
          <td class="text-center" style="border-color:black;text-align:center;"><b>&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia($sub_total); ?></b></td>
          <?php if($this->common->get_particular('mst_purchase_settings',array('purchase_settings_name' => 'purchase_tax_included'),'purchase_settings_value')==1){?>
            <td></td>
            <td class="text-center" style="border-color:black;text-align:center;"><b>&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia($total_tax); ?></b></td>
