  ...
  <div class="row no-margin">
    <table style="width: 100%; border: none;">
     <tbody><tr style="border: none;">
      <th width="100%" style=" border: none;"> <h3><?php echo $company_details['company_name']; ?> SALES RECEIPT REPORTS</h3></th>
     </tr>
   </tbody></table>
   <br>
    <table style="border:1px solid #000; " class="table " border="2" width="100%">
      <thead >
        <tr style="background: rgba(21,76,133,1); ">
          ...
          <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">RECEIPT DATE</h5></th>
          <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">RECEIPT NO</h5></th>
        ...
        <?php if($lists){ 
          ...
          foreach ($lists as $key => $list) { 
            ...
            <tr>
              ...
              <td class="text-center" style="border-color:black;text-align:center;"><?php echo date('d-m-Y',strtotime($list['receipt_date']));?></td>
              <td class="text-center" style="border-color:black;text-align:center;"><?php echo $list['receipt_number'];?></td>
              <td class="text-center" style="border-color:black;text-align:center;"><?php echo $list['customer_name'];?></td>
