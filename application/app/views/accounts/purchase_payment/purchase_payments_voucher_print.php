...
<div class="vocher">
	...
	<div class="vocher_heder">
		...
		<div class="voch_right" style="text-align:center;"><h4>Purchase Voucher</h4>
		...
		<div class="vocher_line">
			...
			<div class="float_left" style="width:220px;text-align: center;border-bottom: 1px solid #333;">
				<span><?php echo $payment['payment_number']; ?></span>
			</div>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td style="border-right:none;">&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia($payment['paid_amount']); ?></td>
				...
				<tr >
					...
					<td style="border-right:none;border-bottom:none;">&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia($payment['paid_amount']); ?></td>
					<!-- <td style="border:none;"></td> -->
				</tr>
			</tbody>
		</table>
	...
	<div class="vocher_footer">
		<div class="vocher_line">
			...
			<div style="width:69.5%;border-bottom:1px solid #333;text-align:center;" class="float_left">
				<span><?php echo ucfirst(convert_number_to_words(round($payment['paid_amount']))); ?></span>
			</div>
