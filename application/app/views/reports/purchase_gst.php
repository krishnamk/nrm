...
<html lang="en">
<head>
  <title><?php echo $company_details['company_name']; ?> GST REPORTS</title>
  <meta charset="UTF-8">
  ...
  <div class="row no-margin">
    <table style="width: 100%; border: none;">
     <tbody><tr style="border: none;">
       <th width="100%" style=" border: none;"> <h3><?php echo $company_details['company_name']; ?> GST REPORTS</h3></th>
     </tr>
   </tbody></table>
    ...
    <table style="border:1px solid #000; " class="table " border="2" width="100%">
      <thead >
        <tr style="background: rgba(21,76,133,1); ">
          ...
          <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">TAX</h5></th>
          <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">IGST</h5></th>
          <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">CGST</h5></th>
          <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">SGST</h5></th>
        </tr>
      </thead>
      <tbody>
        <?php if($lists){
          ...
          foreach ($lists as $key => $list) {   
           ...
           <tr>
            ...
            <?php if($list['company_state'] == $list['supplier_state']){ ?>
            <td>0</td>
