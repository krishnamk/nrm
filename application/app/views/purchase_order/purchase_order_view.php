                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="col-12 ">
                                    <a href="<?php echo base_url('purchase_order_mail/'.$purchase_order_details['purchase_order_id']);?>" style="margin-right: 5px;" class="btn btn-warning float-right"><i class="fa fas fa-mail-bulk"></i>&nbsp;Send Mail</a>
                                    ...
                                    <a href="<?php echo base_url('purchase_order_download/'.$purchase_order_details['purchase_order_id']);?>" style="margin-right: 5px;" class="btn btn-dark float-right"><i class="fa fa-download"></i>&nbsp;Download</a>
                                    <a href="<?php echo base_url('purchase_order');?>" style="margin-right: 5px;" class="btn btn-success float-right"><i class="bx bxs-comment-add font-size-16 align-middle mr-2"></i>&nbsp;New Purchase Order</a>
                                    <a href="<?php echo base_url('purchase_order_list');?>" style="margin-right: 5px;" class="btn btn-info float-right"><i class="fa fas fa-backward"></i>&nbsp;BACK</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <?php if($relations){
                                            ...
                                            foreach ($relations as $key => $relation) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label>&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia($relation['amount']); ?></label></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
