                                    ...
                                    <?php if($lists){
                                        foreach ($lists as $key => $list) { ?>
                                            <tr>
                                                ...
                                                <td><b><i class="fa fa-rupee-sign"></i>&nbsp;&nbsp;&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia($list['purchase_amount']); ?></b></td>
                                                <!-- <td><?php echo payment_status($list['purchase_status']);?></td> -->
                                                <td><a href="#" data-toggle="tooltip" data-placement="top" title="Balance Amt - <?php if(isset($list['balance_amount'])){ echo $list['balance_amount'];}else{echo $list['purchase_amount'];}?>"><?php echo payment_status($list['purchase_status']);?></a>
                                                </td>
