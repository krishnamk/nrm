<div class="main-content">
    <div class="page-content">
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="col-12 ">
                                 <a href="<?php echo base_url('estimate_payment_list');?>" style="margin-right: 5px;" class="btn btn-primary float-right"><i class="fa fas fa-backward"></i>&nbsp;BACK</a>
                             </div>
                         </div>
                     </div>
                 </div>
                        ...
                        <div class="form-body">
                            <div class="card-body">
                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <tbody>
                                        <tr>
                                            <td><label><strong>ESTIMATE NUMBER</strong></label></td>
                                            <td><label><?php echo $payment['estimate_number']; ?></label></td>
                                            <td><label><strong>estimate DATE</strong></label></td>
                                            <td><label><?php echo date('d-m-Y',strtotime($payment['estimate_date'])); ?></label></td>
                                        </tr>
                                        <tr>
                                            <td><label><strong>CUSTOMER NAME</strong></label></td>
                                            <td><label><?php echo $payment['customer_name']; ?></label></td>
                                            <td><label><strong>estimate AMOUNT</strong></label></td>
                                            <td><label>&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia($payment['estimate_amount']); ?></label></td>
                                        </tr>
                                        <tr>
                                            <td><label><strong> BALANCE AMOUNT </strong></label></td>
                                            <td><label>&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia(($payment['estimate_amount']-$payment['paid_amount'])); ?></label></td>
                                            <td><label><strong>ESTIMATE STATUS</strong></label></td>
                                            <td><label><?php echo payment_status($payment['estimate_status']); ?></label></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <div class="form-actions">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <button type="submit" class="btn btn-success add_estimate_payment_show float-right" style="<?php if(($payment['estimate_amount']-$payment['paid_amount'])<=0){ echo 'display: none;'; } ?>">ADD PAYMENT</button> 
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row add_estimate_payment_view" style="display: none;">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="<?php echo base_url('estimate/add_estimate_payment_bills');?>">
                        <div class="card-body">
                        ...
                        <div class="col-md-12">
                           <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="hidden" id="estimate_payments_id" name="estimate_payments_id" class="form-control" placeholder="estimate AMOUNT" value="<?php echo $payment['estimate_payments_id']; ?>" readonly> 
                                ...
                                <input type="text" id="estimate_amount" name="estimate_amount" class="form-control" placeholder="estimate AMOUNT" value="&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia(($payment['estimate_amount'])); ?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">BALANCE AMOUNT</label>
                                <input type="text" style="background-color: #FCF5D8;" id="balance_amount" name="balance_amount" class="form-control form-control-danger" placeholder="BALANCE AMOUNT" value="&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia(($payment['estimate_amount']-$payment['paid_amount'])); ?>" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="control-label">AMOUNT TO BE PAID</label>
                                <input type="text" id="paid_amount" name="paid_amount" class="form-control" placeholder="PLEASE ENTER AMOUNT" value="&#8377;&nbsp;&nbsp;&nbsp;<?php echo MoneyFormatIndia(($payment['estimate_amount']-$payment['paid_amount'])); ?>" >
                            </div>
                            <div class="form-group col-md-6">
