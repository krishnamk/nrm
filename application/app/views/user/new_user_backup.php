                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="access_level" id="user_access_level" data-url="<?php echo base_url('user/access_level_list'); ?>" ><?php if(isset($user)){ echo access_level_options($user['access_level']); }else{ echo access_level_options(); } ?></select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="access_level" id="access_level" class="form-control">
                                                ...
                                                <option <?php if(isset($user)){ if($user['access_level'] == 2){ echo "selected"; } } ?> value="2">ADMIN</option>
                                            </select>
                                        </div>
                                    </div>
                                <?php }elseif($this->session->userdata('access_level') == 2){ ?>
                                    <?php if(isset($user)) { ?> 
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>USER TYPE</label>
                                                <select name="access_level" id="access_level" class="form-control">
                                                    <option>SELECT</option>
                                                    <option <?php if(isset($user)){ if($user['access_level'] == 2){ echo "selected"; } } ?> value="2">ADMIN</option>
                                                    <option <?php if(isset($user)){ if($user['access_level'] == 3){ echo "selected"; } } ?> value="3">USERS</option>
                                                    <option <?php if(isset($user)){ if($user['access_level'] == 4){ echo "selected"; } } ?> value="4">STAFF</option>
                                                </select>
                                            </div>
                                        </div>
                                    <?php } else { ?>
                                    ...
                                    <?php if(isset($user)){ ?> 
                                        <div class="row">
                                            <div class="col-sm-4">
                                               <div class="form-group">
                                                <label ><b><h6>Login Credentials</h6></b></label>
                                            </div> 
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12"><hr>
                                            <div class="form-group">
                                                <label><h5>Select Company List</h5></label>
                                            </div>
                                        </div>
                                        <?php 
                                        if($company_lists){ ?>
