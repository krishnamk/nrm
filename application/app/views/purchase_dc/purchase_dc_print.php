...
<html lang="en">
<head>
  <title><?php echo $purchase_dc_details['purchase_dc_number']; ?></title>
  <meta charset="UTF-8">
  ...
  <div class="row no-margin">
    <table style="width: 100%; border: none;">
     <tbody><tr style="border: none;">
       <th width="100%" style=" border: none;"> <h3>PURCHASE DC</h3></th>
     </tr>
   </tbody></table>
   <table class="invoice_main">
    <tbody>
      <tr style="border-bottom: none;" class="invoice_top_res">
        <td style="border-right: none;width:25%;">  <span><b>PURCHASE DC NO:</b></span></td>
        <td style="width:25%;"> <span><?php echo $purchase_dc_details['purchase_dc_number'];?></span></td>
        <td style="border-right: none;width:25%;">  <span><b>DATE:</b></span></td>
        <td style="width:25%;"> <span> <?php echo date('d-m-Y',strtotime($purchase_dc_details['purchase_dc_date']));?></span></td>
      </tr>
      <tr>
        <td colspan="2">
    ...
    <table style="border:1px solid #000; " class="table " border="2" width="100%">
      <thead >
        <tr style="background: rgba(21,76,133,1); ">
          ...
          <th style="border-color:black;color: #fff;"><h5 class="no-margin-bottom text-center">DESCRIPTION</h5></th>
      ...
      <tbody>
        ...
        foreach ($relations as $key => $relation) {
          ...
          <tr>
            ...
            <td class="text-center" style="border-color:black;text-align:center;"><?php echo $relation['product_description'];?></td>
            <?php if($this->common->get_particular('mst_product_settings',array('product_settings_name' => 'product_brand'),'product_settings_value')== 1) { ?>
        ...
        <?php } ?>
        <tr>
          <td colspan="<?php if(($this->common->get_particular('mst_product_settings',array('product_settings_name' => 'product_brand'),'product_settings_value')== 1)){ ?>4<?php } else{ ?>3<?php } ?>" class="text-center" style="border-color:black;text-align:right;"><b>TOTAL</b></td>
