                        ...
                        <div class="page-title-right">
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="col-12 ">
                                    ...
                                    <a href="<?php echo base_url('purchase_dc_download/'.$purchase_dc_details['purchase_dc_id']);?>" style="margin-right: 5px;" class="btn btn-dark float-right"><i class="fa fa-download"></i>&nbsp;Download</a>
                                    <a href="<?php echo base_url('purchase_dc');?>" style="margin-right: 5px;" class="btn btn-danger float-right"><i class="bx bxs-comment-add font-size-16 align-middle mr-2"></i>&nbsp;Add Purchase DC</a>
                                    <a href="<?php echo base_url('purchase_dc_list');?>" style="margin-right: 5px;" class="btn btn-info float-right"><i class="fa fas fa-backward"></i>&nbsp;BACK</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-nowrap">
                                    ...
                                    <tbody>
                                        <?php if($relations){
                                            ...
                                            <?php } ?>
                                            <tr>
                                                <td colspan='<?php if(($this->common->get_particular('mst_product_settings',array('product_settings_name' => 'product_brand'),'product_settings_value')== 1)){ ?>4<?php } else{ ?>3<?php } ?>'><strong class="float-right">TOTAL</strong></td>
