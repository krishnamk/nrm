          ...
          foreach ($relations as $key => $relation) {
            ...
            <tr>
              ...
              <?php } ?>
                                                  ...
                                                  <div class="seal_footer" style="float: right; width: 96%; margin-top: 30px; border:1px solid #333;height:130px; position:absolute;bottom: 25px;left:2%;">
                                                    
                                                   <div class="seal_part" style="width:100%;text-align: right; padding-bottom:5px;padding-top:5px;padding-right: 20px;">For NRM KNITTEX</div>
                                                   <div class="seal_border" style="width:100%"></div>
