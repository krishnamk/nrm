                                    ...
                                    <?php if($lists){ 
                                        foreach($lists as $key => $purchase_return) { ?>
                                            <tr>
                                                ...
                                                <td><?php return_status($purchase_return['status']);?></td>
                                                <td>
                                                    ...
                                                    <?php if($purchase_return['status']!=2) { ?>
                                                        ...
                                                        <a href="<?php echo base_url('purchase_return_status_change/'.$purchase_return['purchase_return_id']);?>" class="btn btn-dark cancel">Mark as Complete</a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php } }?>
