					...
					<table style="width: 100%; border: none; margin-bottom: 15px;">
						<tbody>
							<tr  style="border: none;margin-top: 25px;">
								<td colspan="2" style="background:#d0d0d0;font-size: 14px; text-align:center"> GSTIN 1111:<?php echo $company_details['company_gst']; ?></td>
							</tr>
							...
							<?php if($relations){
								...
								foreach ($relations as $key => $relation) { 
									...
									<tr style="height:100%;">
										...
										<td><?php echo $relation['rate']; ?></td>
										<td><?php echo $relation['quantity']; ?></td>
										<td><?php echo $relation['discount_percentage']; ?> % </td>
										<td><?php $supplier_price = $this->common->get_particular('mst_products',array('product_id' => $relation['product_id']),'product_selling_price');echo $supplier_price; ?></td>
										<td><?php echo $amount-$relation['pre_total']; ?></td>
										<td><?php echo $relation['pre_total']; ?></td>
									</tr>
								<?php } }?>
								<tr>
									...
									<td style="background:#d0d0d0"><?php echo MoneyFormatIndia($total_before_tax); ?></td>
								</tr>
							</tbody>
						</table>
						...
						<table  style="width: 100%;border: none; margin-bottom: 15px;">
							...
							<tbody>
								...
								<tr style="margin-top:15px;padding-top: 15px;">
									<td style="background:#2e75b6;color:#fff; text-align:center;" colspan="2"><?php echo ucfirst(convert_number_to_words(round($total_after_tax))); ?></td>
									<td colspan="6"></td>
									<td>Add :CGST (2.5%)</td>
									<td><?php if(in_array(5,array_column($taxs, 'tax_percent'))){
								...
								<tr>
									...
									<td  style="width:70px;"><?php if(in_array(5,array_column($taxs, 'tax_percent'))){
										foreach ($taxs as $key => $tax) {
											if($tax['tax_percent'] == 5){
												if($company_details['company_state'] == $customer_details['customer_state'] ){
													echo MoneyFormatIndia($tax['tax_total']/2);
								...
								<tr>
									<td colspan="3" rowspan="4" style="text-align:center;background:#d0d0d0;">
									...
									<td><?php if(in_array(12,array_column($taxs, 'tax_percent'))){
										foreach ($taxs as $key => $tax) {
									...
									<td><?php if(in_array(18,array_column($taxs, 'tax_percent'))){
										foreach ($taxs as $key => $tax) {
									...
									<td><?php if(in_array(28,array_column($taxs, 'tax_percent'))){
										foreach ($taxs as $key => $tax) {
									...
									<td><?php echo MoneyFormatIndia($total_tax); ?></td>
								</tr>
								...
								<tr>
									...
									<td>Sub Total</td>
									<td><?php echo MoneyFormatIndia($total_after_tax); ?></td>
								</tr>
								<tr>
									<td>IGST  :	</td>
									<td><?php if(in_array(5,array_column($taxs, 'tax_percent'))){
									...
									<td>Round Off</td>
									<td><?php echo MoneyFormatIndia($final_price); ?></td>
								</tr>
								<tr>
									<td colspan="3"></td>
									<td colspan="3">Total Amount After Tax</td>
									<td><?php echo MoneyFormatIndia(round($total_after_tax)); ?></td>
								</tr>
							</tbody>
						</table>
						<table  style="width: 100%;border: none; margin-bottom: 15px;">
							...
							<tbody>
								<tr>
									<td style="background:#2e75b6;color:#fff;font-size:14px; text-align:center;" colspan="6">Bank Details</td>
									<td colspan="2">Common Seal</td>
									<td colspan="2" style="font-size:14px;font-weight:bold;">For NRM KNITTEX</td>
								</tr>
								<tr>
									<td style="font-size:10px; padding:3px" colspan="6">Bank A/C        :      <span><?php echo $company_details['company_account_name']; ?></span></td>
									<td colspan="2" rowspan="5"></td>
									<td colspan="2" rowspan="5"></td>

								</tr>
								<tr >
									<td style="font-size:10px; padding:3px" colspan="6">Bank IFSC         :      <span><?php echo $company_details['company_ifsc_code']; ?>	</span></td>

								</tr>
								<tr>
									<td style="font-size:10px; padding:3px" colspan="6">Branch           :      <span>  <?php echo $company_details['company_ifsc_code']; ?>	</span></td>

								</tr>
								<tr>
									<td style="font-size:10px; padding:3px" colspan="6">Bank A/C No        :      <span><?php echo $company_details['company_account_number']; ?>	</span></td>

								</tr>
								<tr>
									<td style="font-size:10px; padding:3px" colspan="6">Bank Name         :      <span><?php echo $company_details['company_bank_name']; ?>	</span></td>
