...
// }
// function return_access_level($access){
// 	$access_levels = access_levels();
// 	foreach ($access_levels as $key => $access_level) {
// 		if($access_level['VALUE'] == $access){
// 			return $access_level['TYPE'];
// 		}
// 	}
// }
// function access_level_option($access =''){
// 	$options = '';
// 	$access_levels = access_levels();
// 	foreach ($access_levels as $key => $access_level) {
// 		$selected="";
// 		if($access != ''){
// 			if( $access == $access_level['VALUE'] ){
// 				$selected = "selected";
// 			}
// 		}
// 		$options .= '<option '.$selected.' value="'.$access_level['VALUE'].'">'.$access_level['TYPE'].'</option>';
// 	}
// 	return $options;
// }
