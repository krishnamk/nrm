                        ...
                        <div class="page-title-right">
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="col-12 ">
                                    ...
                                    <a href="<?php echo base_url('purchase_return_download/'.$purchase_return_details['purchase_return_id']);?>" style="margin-right: 5px;" class="btn btn-primary float-right"><i class="fa fa-download"></i>&nbsp;Download</a>
                                </div>
                            </div>
                        </div>
                    </div>
