                ...
                <?php if($relations){
                    foreach ($relations as $key => $relation) { ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="current_quantity[<?php echo $key; ?>]" style="width:60px;float: left;" class="form-control current_quantity current_quantity<?php echo $key; ?>" data-id="<?php echo $key; ?>" value="<?php echo $relation['quantity']; ?>" readonly>
                            </td>
                            <td>
