            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'sales_return_module'),'settings_value')==1){ ?>
                            <li><a href="invoices-detail.html">Sales Return</a></li>
                        <?php } ?>
                        <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'sales_exchange_module'),'settings_value')==1){ ?>
                ...
                <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_module'),'settings_value')==1){ ?>
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_dc'),'settings_value')==1){ ?>
                                <li><a href="<?php echo base_url('purchase_dc_list'); ?>">Purchase DC</a></li>
                            <?php } ?>
                            <li><a href="<?php echo base_url('purchase_list'); ?>">Purchase</a></li>
                            <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_order'),'settings_value')==1){ ?>
                ...
                <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'expenses_module'),'settings_value')==1){ ?>
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="crypto-wallet.html">New Expenses</a></li>
                        </ul>
                    </li>
                <?php } ?>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <!-- <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'inventory_opening_stock'),'settings_value')==1) { ?> 
                                ...
                                <?php } ?> -->
                                <li><a href="<?php echo base_url('stock_inward');?>">Stock Inward</a></li>
                                <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'inventory_stock_adjustment'),'settings_value')==1) { ?>
                                    <li><a href="<?php echo base_url('stock_adjustment'); ?>">Stock Adjustments</a></li><?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
                        <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'payment_module'),'settings_value')==1){ ?>
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="projects-grid.html">Sales</a></li>
                                    <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_module'),'settings_value')==1){ ?>
                            ...
                            <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'report_module'),'settings_value')==1){ ?>
                                    ...
                                    <ul class="sub-menu" aria-expanded="true">
                                        <li><a href="javascript: void(0);" class="has-arrow">Sales</a>
                                            <ul class="sub-menu" aria-expanded="true">
                                                ...
                                                <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'customer_opening_balance'),'settings_value')==1){ ?>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu" aria-expanded="false">
                                        ...
                                        <?php } ?>
                                        <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'unit_master'),'settings_value')==1) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'uom_master'),'settings_value')==1) { ?>
                                            <li><a href="<?php echo base_url('uom_list'); ?>">SECONDARY UNITS</a></li>
                                        <?php } ?>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu" aria-expanded="false">
                                        ...
                                        <li><a href="<?php echo base_url('company_settings'); ?>">Company Settings</a></li>
