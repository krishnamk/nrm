      ...
      <div class="row no-margin">
        <table style="width: 100%; border: none;">
           <tbody><tr style="border: none;">
             <th width="100%" style=" border: none;"> <h3>PURCHASE ORDER</h3></th>
         </tr>
     </tbody></table>
     <table class="invoice_main">
        <tbody>
          <tr style="border-bottom: none;" class="invoice_top_res">
            <td style="border-right: none;width:25%;">  <span><b>PURCHASE ORDER NO:</b></span></td>
            <td style="width:25%;"> <span><?php echo $purchase_order_details['purchase_order_number'];?></span></td>
            <td style="border-right: none;width:25%;">  <span><b>DATE:</b></span></td>
            <td style="width:25%;"> <span> <?php echo date('d-m-Y',strtotime($purchase_order_details['purchase_order_date']));?></span></td>
        </tr>
        <tr>
            <td colspan="2">
...
<tbody>
  ...
  foreach ($relations as $key => $relation) {
      ...
      <tr>
        ...
        <td class="text-center" style="border-color:black;text-align:center;"><?php echo sprintf("%.2f",$relation['amount']);?></td>
    </tr>
<?php } ?>
<tr>
