                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Company Name</th>
                                        <th>Phone</th>
                                        <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'company_gst'),'settings_value')==1){?>
                                        <th>GST number</th>
                                        <?php } ?>
                                        <th>City</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('company_edit/'.$company['company_id']);?>" class="btn btn-success"><i class="mdi mdi-comment-edit"></i></a>
                                            <a href="<?php echo base_url('company_delete/'.$company['company_id']);?>" class="btn btn-danger cancel"><i class="mdi mdi-delete-circle"></i></a>
                                        </td>
                                    </tr>
                                    <?php } }?>
                                </tbody>
