                                ...
                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><label><?php echo sprintf("%.2f",$payment['purchase_amount']); ?></label></td>
                                        </tr>
                                        <tr>
                                            <td><label><strong> BALANCE AMOUNT </strong></label></td>
                                            <td><label><?php echo sprintf("%.2f",($payment['purchase_amount']-$payment['paid_amount'])); ?></label></td>
                    ...
                    <?php if($payment['history']){
                        foreach ($payment['history'] as $key => $history) { ?>
                            <tr>
                                ...
                                <td><i class="fa fa-rupee-sign"></i>&nbsp;&nbsp;<label><?php echo sprintf("%.2f",($history['paid_amount'])); ?></label></td>
                                ...
                                <td><label><?php if($history['payment_type']=='cash'){
                                    ...
                                    echo 'CHEQUE NUMBER : '.$history['cheque_number'];
                                }else{
                        ...
                        <div class="col-md-12">
                           <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="hidden" id="purchase_payments_id" name="purchase_payments_id" class="form-control" placeholder="PURCHASE AMOUNT" value="<?php echo sprintf("%.2f",($payment['purchase_payments_id'])); ?>" readonly> 
                                <input type="hidden" id="supplier_id" name="supplier_id" class="form-control" value="<?php echo sprintf("%.2f",($payment['supplier_id'])); ?>" readonly> 
                                <input type="text" id="purchase_amount" name="purchase_amount" class="form-control" placeholder="PURCHASE AMOUNT" value="<?php echo sprintf("%.2f",($payment['purchase_amount'])); ?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">BALANCE AMOUNT</label>
                                <input type="text" id="balance_amount" name="balance_amount" class="form-control form-control-danger" placeholder="BALANCE AMOUNT" value="<?php echo sprintf("%.2f",($payment['purchase_amount']-$payment['paid_amount'])); ?>" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="control-label">AMOUNT TO BE PAID</label>
                                <input type="text" id="paid_amount" name="paid_amount" class="form-control" placeholder="PLEASE ENTER AMOUNT" value="<?php echo sprintf("%.2f",($payment['purchase_amount']-$payment['paid_amount'])); ?>" >
                            </div>
                            <div class="form-group col-md-6">
