        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form method="post" id="purchase_form">
                            ...
                            <div class="form-body">
                                <div class="card-body">
                                 ...
                                 <div class="form-group col-md-1">
                                    ...
                                    <a class="btn btn-primary add_purchase_dc_new" id="add_purchase_dc_new" data-id="<?php if($total_products){ echo $total_products; } ?>" data-toggle="tooltip" data-placement="top" title="ADD PRODUCT"><i class="fa fa-plus">&nbsp;</i></a>
                                </div>
                            <?php } else{ ?>
                                <div class="form-group col-md-2">
                            ...
                            <?php } ?>
                            <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_stock_add'),'settings_value')==1){?>
                                <div class="form-group col-md-1">
                                    <label class="control-label col-lg-12">&nbsp;</label>
                ...
                <div class="row  purchase_product_list" style="<?php //if(isset($purchase_details)){ echo'display: block;';}else{ echo'display: none;'; } ?>">
                    <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_dc'),'settings_value')==0) { ?> 
                     <div class="col-md-12">
