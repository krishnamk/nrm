                        ...
                        <div class="page-title-right">
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="col-12 ">
                                   ...
                                   <a href="<?php echo base_url('purchase_print/'.$purchase_details['purchase_id']);?>" style="margin-right: 5px;" class="btn btn-primary float-right"><i class="fa fa-print"></i>&nbsp;Print</a>
                                        ...
                                        <?php if($relations){
                                            ...
                                            foreach ($relations as $key => $relation) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label><?php echo sprintf("%.2f",($relation['quantity']*$relation['rate'])); ?></label></td>
                                                    <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_tax_included'),'settings_value')==1){?> 
                                                     <td><label><?php echo $relation['tax_percent']; ?></label></td>
                                                     <td><label><?php echo sprintf("%.2f",$relation['tax_total']); ?></label></td>
                                                     <td><label><?php echo sprintf("%.2f",$relation['total']); ?></label></td>
                                                 <?php } ?>
                                             </tr>
                                         <?php } ?>
                                         <tr>
                                            ...
                                            <td></td>
                                            <td><label><?php echo sprintf("%.2f",$sub_total); ?></label></td> 
                                            <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_tax_included'),'settings_value')==1){?> 
                                                <td></td>
                                                <td><label><?php echo sprintf("%.2f",$total_tax); ?></label></td>
