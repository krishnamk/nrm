...
<html lang="en">
<head>
  <title><?php echo $purchase_details['purchase_number']; ?></title>
  <meta charset="UTF-8">
  ...
  <div class="row no-margin">
    <table style="width: 100%; border: none;">
     <tbody><tr style="border: none;">
       <th width="100%" style=" border: none;"> <h3>PURCHASE</h3></th>
     </tr>
   </tbody></table>
   <table class="invoice_main">
    <tbody>
      <tr style="border-bottom: none;" class="invoice_top_res">
        <td style="border-right: none;width:25%;">  <span><b>PURCHASE NO:</b></span></td>
        <td style="width:25%;"> <span><?php echo $purchase_details['purchase_number'];?></span></td>
        <td style="border-right: none;width:25%;">  <span><b>DATE:</b></span></td>
        <td style="width:25%;"> <span> <?php echo date('d-m-Y',strtotime($purchase_details['purchase_date']));?></span></td>
      </tr>
      <tr>
        <td colspan="2">
    ...
    <table style="border:1px solid #000; " class="table " border="2" width="100%">
      <thead >
        <tr style="background: rgba(21,76,133,1); ">
          ...
          <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_tax_included'),'settings_value')==1){?>
        ...
        <tbody>
          ...
          foreach ($relations as $key => $relation) {
            ...
            <tr>
              ...
              <td class="text-center" style="border-color:black;text-align:center;"><?php echo sprintf("%.2f",$relation['rate']);?></td>
              <td class="text-center" style="border-color:black;text-align:center;"><?php echo sprintf("%.2f",($relation['quantity']*$relation['rate']));?></td>
              <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_tax_included'),'settings_value')==1){?>
                <td class="text-center" style="border-color:black;text-align:center;"><?php echo $relation['tax_percent'];?></td>
                <td class="text-center" style="border-color:black;text-align:center;"><?php echo sprintf("%.2f",$relation['tax_total']);?></td>
                <td class="text-center" style="border-color:black;text-align:center;"><?php echo sprintf("%.2f",$relation['total']);?></td>
              <?php } ?>
            </tr>
          <?php } ?>
          <tr>
            <td colspan="3" class="text-center" style="border-color:black;text-align:right;"><b>TOTAL</b></td>
            <td class="text-center" style="border-color:black;text-align:center;"><b><?php echo $total_quantity; ?></b></td>
            <td></td>
            <td class="text-center" style="border-color:black;text-align:center;"><b><?php echo sprintf("%.2f",$sub_total); ?></b></td>
            <?php if($this->common->get_particular('mst_settings',array('settings_name' => 'purchase_tax_included'),'settings_value')==1){?>
              <td></td>
              <td class="text-center" style="border-color:black;text-align:center;"><b><?php echo sprintf("%.2f",$total_tax); ?></b></td>
              <td class="text-center" style="border-color:black;text-align:center;"><b><?php echo sprintf("%.2f",$total_amount); ?></b></td>
            <?php } ?>
          </tr>
        </tbody>
      </table>
